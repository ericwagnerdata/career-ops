...
Run exactly the same as the `evaluate` mode (read `modes/evaluate.md` for all A-F blocks).
...
Register in `data/applications.md` with all columns including Report and PDF marked ✅.
